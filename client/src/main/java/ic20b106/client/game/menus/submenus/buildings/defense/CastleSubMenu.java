 ...
 * @version 1.0
 *
 * Submenu of the Castle Building
 */
public class CastleSubMenu extends BuildingSubMenu {

    @FXML
    private HBox castleBox;
     ...
     */
    public CastleSubMenu(Cell selectedCell, Building building) throws IOException {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        castleBox.getChildren().add(destroyBox);
    }
}
