 ...
 */
public class SmelterySubMenu extends BuildingSubMenu {

    @FXML
    private HBox smelteryBox;
     ...
     */
    public SmelterySubMenu(Cell selectedCell, Building building) throws IOException {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        smelteryBox.getChildren().add(destroyBox);
    }
}
